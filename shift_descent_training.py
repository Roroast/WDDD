...
lrs = list(np.logspace(3, 4, num = 2, base = np.e))
...
experiment(shift_descent_DF)
shift_descent_DF['loss'] = shift_descent_DF['loss_values'].str[-1]
shift_descent_DF.to_pickle("shift_descent_DF_ext.pkl")